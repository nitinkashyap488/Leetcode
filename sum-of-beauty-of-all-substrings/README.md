<h2>1781. Sum of Beauty of All Substrings</h2><h3>Medium</h3><hr><div><p>The <strong>beauty</strong> of a string is the difference in frequencies between the most frequent and least frequent characters.</p>
